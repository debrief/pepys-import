...
def upgrade():
    ...
    with op.batch_alter_table(
        "ClassificationTypes", schema=None, copy_from=ClassificationTypeUpgrade.__table__
    ) as batch_op:
    ...
    with op.batch_alter_table(
        "ConfidenceLevels", schema=None, copy_from=ConfidenceLevelUpgrade.__table__
    ) as batch_op:
    ...
    with op.batch_alter_table(
        "ContactTypes", schema=None, copy_from=ContactTypeUpgrade.__table__
    ) as batch_op:

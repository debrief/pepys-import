...
You should change values in :code:`create_alembic_version_table` to stamp the database with the latest migration when a DataStore is initialised.
Check your revision number and change the corresponding database's values: (Line 76-77 for SQLite, Line 89-91 for PostgreSQL).
